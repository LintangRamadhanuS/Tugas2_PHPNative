...
echo "<br/>";
echo "Jenis Kelamin kalian adalah : " . $jenis;
echo "<br/>";
echo "Agama kalian adalah : " . $agama;
echo "<br/>";
echo "Alamat kalian adalah : " . $alamat;
echo "<br/>";
echo "Tempat Lahir  kalian adalah : " . $TL;
echo "<br/>";
echo "Tanggal Lahir kalian adalah : " . $tanggal;
echo "<br/>";
echo "Hobi kalian adalah : " . $hobi;
echo "<br/>";
echo "Cita-cita kalian adalah  : " . $cita;
echo "<br/>";
echo "Usia kalian adalah : " . $usia;
echo "<br/>";
echo "Asal Sekolah kalian adalah : " . $sekolah;
echo "<br/>";
?>
